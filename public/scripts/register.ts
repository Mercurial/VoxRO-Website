...
app.controller('RegisterPageController',['$scope', '$http', function($scope:  angular.IScope, $http: angular.IHttpService) { 
	...
	this.doRegistration = function()
	{
		...
		data.captchaValue = (<HTMLTextAreaElement>document.getElementById("g-recaptcha-response")).value;
